<main role="main" class="container">
    <?php if(!empty($viewTextures)) { ?>
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="span border border-gray bg-light p-3">
            <h5 class="d-inline-block m-0"> Mcpe </h5>
            <small class="text-left ml-1"> All Mcpe </small>
            <?php if(!empty($this->session->userdata['user_role'])) { ?>
                <?php if($this->session->userdata['user_role'] == "Administrator") { ?>
                    ...
                    <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>new-textures" class="text-white"> New Textures </a></div>
                ...
                <?php } ?>
            <?php } ?>
            <?php $sessionTexturesView =  $this->session->userdata('session_textures_view'); ?>
            <form method="post">
                <div class="row">
                    <div class="col-md-9 mt-3">
                        <input type="text" name="search_textures_view" class="form-control" autocomplete="off" value="<?php echo $sessionTexturesView; ?>" placeholder="Search..." >
                    </div>
        ...
        <div class="pt-2 overflow-none">
            <div class="row small">
                <?php foreach($viewTextures as $data) { ?>
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="card my-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>edit-textures/<?php echo md5($data['unique_id']);?>" class="text-white"> Edit Data </a></div>
                            </div>
                        </div>
                    </div> 
                </div>
    ...
    <?php if(empty($viewTextures)) { ?>
        <div class="my-3 p-4 bg-white rounded box-shadow">
            <div class="span small text-center">
                ...
                <h5 class="d-block mb-1">Textures Database is Empty</h5>
                <p class="d-block mb-3">Please add textures from the below button.</p>
                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>new-textures" class="text-white"> New Textures </a></div>
            </div> 
        </div>
    <?php } ?>
</main>
