<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="span border border-gray bg-light p-3">
            ...
            <?php if(!empty($this->session->userdata['user_role'])) { ?>
                <?php if($this->session->userdata['user_role'] == "Administrator") { ?>
                    ...
                    <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>new-shaders" class="text-white"> New Shaders </a></div>
                ...
                <?php } ?>
            <?php } ?>
            <?php $sessionShadersView =  $this->session->userdata('session_shaders_view'); ?>
            <form method="post">
                <div class="row">
                    <div class="col-md-9 mt-3">
                        <input type="text" name="search_shaders_view" class="form-control" autocomplete="off" value="<?php echo $sessionShadersView; ?>" placeholder="Search..." >
                    </div>
        ...
        <div class="pt-2 overflow-none">
            <div class="row small">
                <?php foreach($viewShaders as $data) { ?>
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="card my-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>edit-shaders/<?php echo md5($data['unique_id']);?>" class="text-white"> Edit Data </a></div>
                            </div>
                        </div>
                    </div> 
                </div>
    ...
    <?php if(empty($viewShaders)) { ?>
        <div class="my-3 p-4 bg-white rounded box-shadow">
            <div class="span small text-center">
                ...
                <h5 class="d-block mb-1">Shaders Database is Empty</h5>
                <p class="d-block mb-3">Please add shaders from the below button.</p>
                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>new-shaders" class="text-white"> New Shaders </a></div>
            </div> 
        </div>
    <?php } ?>
</main>
