        ...
        <div class="span border border-gray bg-light p-3">
            ...
            <?php if(!empty($this->session->userdata['user_role'])) { ?>
                <?php if($this->session->userdata['user_role'] == "Administrator") { ?>
                    ...
                    <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>new-maps" class="text-white"> New Maps </a></div>
                ...
                <?php } ?>
            <?php } ?>
            <?php $sessionMapsView =  $this->session->userdata('session_maps_view'); ?>
            <form method="post">
                <div class="row">
                    <div class="col-md-9 mt-3">
                        <input type="text" name="search_maps_view" class="form-control" autocomplete="off" value="<?php echo $sessionMapsView; ?>" placeholder="Search..." >
                    </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="card my-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>edit-maps/<?php echo md5($data['unique_id']);?>" class="text-white"> Edit Data </a></div>
                            </div>
                        </div>
                    </div> 
                </div>
    ...
    <?php if(empty($viewMaps)) { ?>
        <div class="my-3 p-4 bg-white rounded box-shadow">
            <div class="span small text-center">
                ...
                <h5 class="d-block mb-1">Maps Database is Empty</h5>
                <p class="d-block mb-3">Please add maps from the below button.</p>
                <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>new-maps" class="text-white"> New Maps </a></div>
            </div> 
        </div>
    <?php } ?>
</main>
