<main role="main" class="container">
    <?php if(!empty($viewCategoryMaps)) { ?>
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="span border border-gray bg-light p-3">
          <h5 class="d-inline-block m-0"> Category Maps </h5>
          <small class="text-left ml-1"> All Category Maps </small>
          <?php if(!empty($this->session->userdata['user_role'])) { ?>
                <?php if($this->session->userdata['user_role'] == "Administrator") { ?>
                    ...
                    <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>new-category-maps" class="text-white"> New Category Maps </a></div>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr class="small">
                        ...
                        <td> 
                            <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>edit-category-maps/<?php echo md5($data['category_id']);?>" class="text-white"><i class="far fa-edit"></i></a></div>
                        </td>
                    </tr>
                  <?php } ?>
                </table>
    ...
    <div class="my-3 p-4 bg-white rounded box-shadow">
        <div class="span small text-center">
            ...
            <h5 class="d-block mb-1">Category Maps Database is Empty</h5>
            <p class="d-block mb-3">Please add category maps from the below button.</p>
            <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>new-category-maps" class="text-white"> New Category Maps </a></div>
        </div> 
    </div>
    <?php } ?>
</main>
