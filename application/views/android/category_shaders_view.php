<main role="main" class="container">
          ...
          <small class="text-left ml-1"> All Category Shaders </small>
            <?php if(!empty($this->session->userdata['user_role'])) { ?>
                <?php if($this->session->userdata['user_role'] == "Administrator") { ?>
                    ...
                    <div class="btn btn-primary btn-sm mb-0 mb-md-0"><a href="<?php echo base_url();?>new-category-shaders" class="text-white"> New Category Shaders </a></div>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr class="small">
                        ...
                        <td> 
                          <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>edit-category-shaders/<?php echo md5($data['category_id']);?>" class="text-white"><i class="far fa-edit"></i></a></div>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
    ...
    <div class="my-3 p-4 bg-white rounded box-shadow">
      <div class="span small text-center">
        ...
        <div class="btn btn-primary btn-sm mb-0 mb-md-2"><a href="<?php echo base_url();?>new-category-shaders" class="text-white"> New Category Shaders </a></div>
      </div> 
    </div>
  <?php } ?>
</main>
