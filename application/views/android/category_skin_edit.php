<main role="main" class="container">
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="span border border-gray bg-light p-3">
            ...
            <small class="text-left ml-1"> Edit Category Skin </small>
            ...
            <div class="pt-3 overflow-none">     
                <div class="row small">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="category_name" class="form-control" value="<?php echo $categorySkinData->category_name ?>" placeholder="Enter Category Name">
                    </div>
                    <div class="form-group col-md-12">
                        <label>Category Status *</label>
                        <select name="category_status" class="form-control">
                            <option value="<?php echo $categorySkinData->category_status ?>"> <?php echo $categorySkinData->category_status ?> </option>
